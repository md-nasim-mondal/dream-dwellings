...
const Contact = () => {
    ...
    return (
        ...
        <Helmet>
            ...
            <h1 className="text-2xl md:text-5xl flex items-center font-bold text-black"><IoMdContact className="text-7xl text-blue-600" /> Contact With Us</h1>
            <div className="flex flex-col md:flex-row justify-center gap-8 mt-12">
                ...
                <div className="flex flex-col gap-4 items-center md:items-start">
                    <h3 className="text-3xl text-black">Visit our social pages</h3>
                    ...
                    <h3 className="text-3xlb text-black">Chat With Us</h3>
                    <div className="text-4xl flex gap-4 text-blue-500">
                    ...
                    <a className="text-3xl text-black" href="#">01699308-485</a>
                </div>
            </div>
            <h3 className="text-3xl font-semibold text-center mt-12 text-black">Thanks for visiting us</h3>
        </div>
    );
};
